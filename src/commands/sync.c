...
void vkCmdSetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkFlags stageMask) {
	(void)commandBuffer;
	(void)event;
	(void)stageMask;
...
void vkCmdResetEvent(VkCommandBuffer commandBuffer, VkEvent event, VkFlags stageMask) {
	(void)commandBuffer;
	(void)event;
	(void)stageMask;
}
...
void vkCmdWaitEvents(VkCommandBuffer commandBuffer, uint32_t eventCount, const VkEvent *pEvents,
                     uint32_t srcStageMask, uint32_t dstStageMask, uint32_t memoryBarrierCount,
