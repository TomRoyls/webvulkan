...
#define WEBVULKAN_MAKE_VERSION(major, minor, patch) (((major) << 22) | ((minor) << 12) | (patch))

#define WEBVULKAN_VERSION                                                    \
	WEBVULKAN_MAKE_VERSION(WEBVULKAN_VERSION_MAJOR, WEBVULKAN_VERSION_MINOR, \
	                       WEBVULKAN_VERSION_PATCH)
